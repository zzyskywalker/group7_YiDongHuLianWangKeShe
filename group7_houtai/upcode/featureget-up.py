# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 16:09:33 2020
...
argvs = sys.argv
params = {}
params["path"]="C:/Users/33578/Desktop/TEST1_cleaned.csv"
params["opath"]="C:/Users/33578/Desktop/TEST1_feature.csv"
params["windowsize"]=250
...
try:
    ...
    pd_data=pd.read_csv(params["path"])
    result_list=[]
    for j in range(2):
        feature_list=[]
    ...
    result_frame.to_csv(params["opath"],index=False)
